...
class PokemonStorageScene
  ...
  def pbUpdateOverlay(selection, party = nil)
    ...
    if !pokemon.egg?
      ...
      textstrings.push([pokemon.level.to_s, 28+54, 262, :left, Color.new(255, 255, 255), Color.new(90, 82, 82)])
      if pokemon.ability
      ...
      if pokemon.item
        ...
        textstrings.push([_INTL("Sin objeto"), 16, 360, :left, nonbase, nonshadow])
      end
      # Changed Shiny Icon
