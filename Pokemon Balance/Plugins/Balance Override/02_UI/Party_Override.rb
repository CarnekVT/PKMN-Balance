...
class PokemonPartyBlankPanel < Sprite
  ...
  def initialize(_pokemon, index, viewport = nil)
    super(viewport)
    self.x = ((index % 2) * Graphics.width / 2.14) + 42
    self.y = (1 * (index % 2)) + (96 * (index / 2)) + 40
...
class PokemonPartyPanel < Sprite
  ...
  def initialize(pokemon, index, viewport = nil)
    ...
    if @active   # Rounded panel
      ...
      @panelbgsprite.addBitmap("stat", "Graphics/UI/Party/panel_round_statuses")
      @panelbgsprite.addBitmap("statsel", "Graphics/UI/Party/panel_round_statuses_sel")
      @panelbgsprite.addBitmap("statsel2", "Graphics/UI/Party/panel_round_statuses_sel2")
      ...
      @panelbgsprite.addBitmap("stat", "Graphics/UI/Party/panel_rect_statuses")
      @panelbgsprite.addBitmap("statsel", "Graphics/UI/Party/panel_rect_statuses_sel")
      @panelbgsprite.addBitmap("statsel2", "Graphics/UI/Party/panel_rect_statuses_sel2")
    end
    ...
    @hpbgsprite.addBitmap("stat", _INTL("Graphics/UI/Party/overlay_hp_back_stat"))
  ...
  def refresh_panel_graphic
    ...
    if self.selected
      if self.preselected
        ...
        @panelbgsprite.changeBitmap("statsel")
      else
      ...
      if self.preselected
        ...
        @panelbgsprite.changeBitmap("stat")
      else
  ...
  def draw_gender
    ...
    pbDrawTextPositions(@overlaysprite.bitmap,
                        [[gender_text, 236, 22, :left, base_color, shadow_color]])
  end
...
class PokemonParty_Scene
  ...
  def pbUpdate
    ...
    @sprites["partybg"].x  = 0 if @sprites["partybg"].x == - 56
    @sprites["partybg"].x -= 2 if BagScreenWiInParty::PANORAMA == true
  end
